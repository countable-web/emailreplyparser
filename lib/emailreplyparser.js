...
Email.prototype = {
  ...
  // Splits the given text into a list of Fragments.  This is roughly done by
	...
	scan_line: function(line) {
		var SIG_REGEX = new RegExp('(--|__|\\w-$)|(^(\\w+\\s*){1,3} ' + reverse('Sent from my') +  '$)');
		...
		if (this.fragment != null && line === '') {
			if (SIG_REGEX.test(this.fragment.last_n_line(1)) || 
			   (SIG_REGEX.test(this.fragment.last_n_line(2)) && !QUOTED_REGEX.test(this.fragment.last_n_line(2)))) {
		...
		if (this.fragment != null && ((this.fragment.quoted === is_quoted) || (this.fragment.quoted && (this.quote_header(line) || line === '')))) {
			...
			if (this.quote_header(line) && !this.fragment.quoted) {
